  ...
  <>
    ...
    <div className="space-y-6 sm:space-y-8">
      <div>
        ...
        <p className="text-[var(--text-primary)]">By accessing or using Nexus AI, you agree to these Terms of Service. If you do not agree, please do not use the platform.</p>
      </div>
      <div>
        ...
        <ul className="list-disc pl-4 sm:pl-6 space-y-1 text-[var(--text-primary)]">
          <li>You must be at least 13 years old to use Nexus AI.</li>
          <li>You are responsible for your account security and activity.</li>
          <li>Do not use Nexus AI for unlawful, harmful, or abusive purposes.</li>
      ...
      <div>
        ...
        <p className="text-[var(--text-primary)]">All content, trademarks, and technology on Nexus AI are owned by Nexus AI or its licensors. You may not copy, modify, or distribute any part of the service without permission.</p>
      </div>
      <div>
      ...
      <div>
        ...
        <p className="text-[var(--text-primary)]">Nexus AI is provided "as is" without warranties of any kind. We do not guarantee accuracy, reliability, or availability. Use the service at your own risk.</p>
      </div>
      <div>
        <h2 className="text-lg sm:text-xl font-bold text-[var(--accent)] mb-2">Limitation of Liability</h2>
        <p className="text-[var(--text-primary)]">Nexus AI is not liable for any indirect, incidental, or consequential damages arising from your use of the service.</p>
      </div>
      <div>
        <h2 className="text-lg sm:text-xl font-bold text-[var(--accent)] mb-2">Changes to Terms</h2>
        <p className="text-[var(--text-primary)]">We may update these Terms of Service. Continued use of Nexus AI after changes means you accept the new terms.</p>
      </div>
      <div>
