      ...
      <div className="max-w-3xl mx-auto bg-[var(--bg-tertiary)]/40 rounded-2xl sm:rounded-3xl border border-[var(--border)] focus-within:border-[var(--text-secondary)]/30 transition-all shadow-xl relative">
        ...
        <div className="flex items-end p-1.5 sm:p-2 gap-1">
          ...
          <textarea
            ...
            className={inputPlaceholderClass + " w-full resize-none bg-transparent border-none outline-none focus:ring-0 text-[var(--text-primary)] placeholder-[var(--text-secondary)] text-base sm:text-lg leading-relaxed flex-1 py-2.5 sm:py-3 px-1 sm:px-2 transition-all placeholder:text-[var(--text-secondary)]/40 text-[15px] sm:text-base overflow-hidden overflow-y-auto"}
            disabled={isDisabled}
            rows={1}
