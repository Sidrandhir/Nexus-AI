        ...
        <div className={`section-inner ${isVisible('how-it-works') ? 'visible' : ''}`}>
          ...
          <div className="steps-container">
            ...
            {[
              ...
              <div key={step.num} className={`step-card ${isVisible('how-it-works') ? 'visible' : ''}`} style={{ transitionDelay: `${i * 200}ms` }}>
        ...
        <div className={`section-inner ${isVisible('capabilities') ? 'visible' : ''}`}>
          ...
          <div className="cap-grid">
            {[
              ...
              <div key={cap.title} className={`cap-card ${cap.gradient} ${isVisible('capabilities') ? 'visible' : ''}`} style={{ transitionDelay: `${i * 150}ms` }}>
      ...
      <section id="why-nexus" className="pain-section" data-animate>
        <div className={`section-inner ${isVisible('why-nexus') ? 'visible' : ''}`}>
          ...
          <div className="pain-grid">
            ...
            <div className={`pain-card pain-new ${isVisible('why-nexus') ? 'visible' : ''}`} style={{ transitionDelay: '200ms' }}>
        ...
        <div className={`section-inner ${isVisible('features') ? 'visible' : ''}`}>
          ...
          <div className="features-grid">
            {[
              ...
              <div key={feat.title} className={`feature-card ${isVisible('features') ? 'visible' : ''}`} style={{ transitionDelay: `${i * 80}ms` }}>
